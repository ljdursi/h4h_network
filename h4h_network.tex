...
books and the use of the \doccls{tufte-book} and \doccls{tufte-handout} document classes.
...
\chapter{Data Science at Scale for Human Health}
\label{ch:data-at-scale}
...
\begin{figure}
 \includegraphics{cumulative_genomes.pdf}
  \caption[Cumulative number of human genomes sequenced]{The cumulative number of human genomes sequenced over the past 15 years,
    data from \protect\citep{stephens2015big}}
...
To enter multiple citations at one location, you can
